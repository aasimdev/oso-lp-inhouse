...
import Ciaran from '../../../public/assets/images/no-photo.jpg'


const testimonialData = [
    {
        name: "Jason K.",
        description: "I stopped using chatGPT bc it never gives me answers I want. I use OSO daily bc it's real time and uncensored giving me exactly what I need.",
        image: Jason
    },
    {
        name: "Jan Gerych",
    ...
    {
        name: "Michael S.",
        description: "It's next level from chatGPT bc you can pull data about real time trends, sentiment and analytics. Content creators are going to make a lot of money with OSO.",
        image: Michael
    },
    {
        name: "Steve A.",
    ...
    return (
        <section className="pt-12 sm:pt-[120px]">
            <div className='md:text-center text-left mb-16 px-6 mx-auto max-w-6xl'>
                <h2 className='text-[40px] leading-tight md:text-5xl md:leading-relaxed font-bold text-black'>Many people already feel the magic</h2>
            </div>
                ...
                >
                    {isDesktop && <>
                        ...
                        <div className="swiper-button-prev md:ml-24 !w-12 !h-12 rounded-full bg-gray-40 p-3 transition-all duration-300 hover:bg-gray-50 focus:bg-gray-30">
                            <svg width="24" height="24" viewBox="0 0 24 24" className='rotate-180' fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 4L10.59 5.41L16.17 11H4V13H16.17L10.59 18.59L12 20L20 12L12 4Z" fill="black" />
                            </svg>
