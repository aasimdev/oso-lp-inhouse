  ...
  return (
    <div className="flex flex-col space-y-6 text-[#212B36] py-24 max-w-6xl px-6 mx-auto ">
      ...
      <p className="font-light text-2xl leading-8">
        ...
        relevant information about us and our business. The customer&apos;s
        email address or other contact will be added to the mailing list unless
        the customer opts out of receiving marketing communications. If the user
      ...
      <p className="font-light text-2xl leading-8">
        ...
        servers. We do not have access to a user&apos;s contacts or other
        messages not addressed to our Service unless they provide us with
        specific permission. Use of the instant messaging service or other
        third-party interface service is subject to the third-party
        provider&apos;s terms and conditions and privacy policy. The User must
        maintain access to the Instant Messaging Service or other interface
        service in order to properly use the Service.
      </p>
      ...
      <p className="font-light text-2xl leading-8">
        ...
        provider&apos;s website for relevant information about the plugin and
      ...
      <p className="font-light text-2xl leading-8">
        ...
        user&apos;s consent to be stored on the user&apos;s device. In addition
        to technical cookies, we might use technologies to collect data relating
        to our advertisement and website usage using cookies or similar
