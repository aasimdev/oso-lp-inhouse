...
const AdvantageCard = ({ title, description, borderLess,  image2 , image, imageWidth, imageHeight, color , className }) => {

  return (
    <div className={`rounded-2xl lg:p-16 p-8 relative overflow-hidden lg:min-h-[571px] h-[639px] md:h-full  z-0 ${color ? color : "default"}-box`}>
      <div className='flex flex-col lg:flex-row justify-between'>
        <div className={`flex gap-4 md:gap-6 flex-col max-w-md ${borderLess ? 'lg:order-2' : 'lg:order-1'}`}>
