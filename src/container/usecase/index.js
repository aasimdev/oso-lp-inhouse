...
const UseCase = () => {
  ...
  return (
    <>
      <section className="sm:mt-8 sm:py-8 px-6 mx-auto max-w-6xl">
        ...
        <div className="flex gap-2  px-6 flex-wrap md:justify-center md:px-24 py-6">
          <div>
            {" "}
            <Category text="All" />
          </div>
