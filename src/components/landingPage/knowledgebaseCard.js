...
const KnowledgebaseCard = ({ title, url }) => {
  return (
    <>
      <Link href={url} target="_blank" className="p-8 bg-white rounded-2xl border border-gray-30 flex-col justify-between items-end gap-[38px] inline-flex hover:bg-gradient-gray">
