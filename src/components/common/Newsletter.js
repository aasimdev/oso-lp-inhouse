...
const Newsletter = () => {
    ...
    return (
        <>
            ...
            <form className='relative transition-all mt-4 mb-7 sm:mb-12' onSubmit={form?.handleSubmit}>
                <input
                    type="email"
                ...
                <button disabled={!form?.values.email} className='absolute right-6 top-1/2 -translate-y-1/2' onClick={handleJoinWaitlistClick}>
