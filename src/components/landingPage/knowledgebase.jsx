  ...
  return (
    <>
      <section className="px-6 mx-auto max-w-6xl">
        {/* Knowledgebase */}
        <div className="bg-[#f67bf6] p-8 md:p-16 rounded-2xl flex flex-col md:flex-row gap-8 md:gap-2 justify-between items-start">
          <div className="w-full flex-auto">
            <h5 className="text-white font-bold text-[32px] sm:text-5xl mb-2">
              Knowledgebase
            </h5>
            <p className="text-2xl font-light text-white md:w-[422px] leading-loose">
          ...
          <div className="w-full text-right">
            <Link
              ...
              target="_blank"
              className="inline-flex items-center justify-end gap-4 text-white text-base"
            >
              <span>Lean more</span>
              <svg
                width="33"
