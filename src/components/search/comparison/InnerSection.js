    ...
    >
      <div className='md:flex md:flex-nowrap flex-wrap justify-between'>
        <div className='contentWrap w-full md:w-[346px] md:mt-[52px] flex flex-col gap-12 md:gap-9 flex-grow-0 flex-shrink-0 basis-auto mb-12 sm:mb-0'>
          {/* Stay Updated */}
          <div
            className={`text-block opacity-100 cursor-pointer ${divVisibility.stay ? "md:opacity-100" : "md:opacity-20"
              }`}
          ...
          {/* Plan your event */}
          <div
            className={`text-block cursor-pointer ${divVisibility.plan ? "md:opacity-100" : "md:opacity-20"
              }`}
          ...
          {!isMobile && (
            <div
              className={`text-block cursor-pointer ${divVisibility.deep ? "md:opacity-100" : "md:opacity-20"
                }`}
        ...
        {!isMobile && (
          <div className='right-elemetns relative overflow-hidden w-full flex '>
            <div className='w-full h-full relative overflow-hidden'>
              <div
                className={`phoneWrap flex flex-nowrap md:justify-end 0 md:mt-0 mt-16 absolute left-0 top-0 right-0 bottom-0 opacity-0 transition-opacity duration-300 ease-in-out ${divVisibility.stay ? "opacity-100" : ""
                  }`}
              >
                <Phone title='OSO' obj='869795820' />
                <Phone title='ChatGPT' obj='869795832' />
              ...
              <div
                className={`phoneWrap flex flex-nowrap md:justify-end 0 md:mt-0 mt-16 absolute left-0 top-0 right-0 bottom-0 opacity-0 transition-opacity duration-300 ease-in-out ${divVisibility.plan ? "opacity-100" : ""
                  }`}
              >
                <Phone title='OSO' obj='869795741' />
                <Phone title='ChatGPT' obj='869795758' />
              ...
              <div
                className={`phoneWrap flex flex-nowrap md:justify-end 0 md:mt-0 mt-16 absolute left-0 top-0 right-0 bottom-0 opacity-0 transition-opacity duration-300 ease-in-out ${divVisibility.deep ? "opacity-100" : ""
                  }`}
              >
