            ...
            <div className='px-6 mx-auto max-w-6xl'>
                <div className="pt-8 md:pt-24">
                    ...
                    <div className='flex flex-col md:gap-6 gap-2  md:mb-6'>
                        <h1 className="md:text-[64px] text-[40px] md:text-center text-left font-extrabold leading-[56px] md:leading-[80px] text-black max-w-4xl mx-auto" dangerouslySetInnerHTML={{ __html: title }}>
                        </h1>
