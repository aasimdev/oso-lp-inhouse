  ...
  return (
    <div className='mt-14 p-8 md:p-16 h-full md:h-[571px] group rounded-2xl relative lp-chat-box overflow-hidden'>
      ...
      <div className='relative lg:flex justify-end mt-[51px] md:gap-[55.32px] mr-4'>
        <Image
          className='absolute md:static top-[87%] lg:mt-5 left-2 md:top-0 h-8 w-8 md:w-[69px] md:h-[64px]  '
      ...
      <div>
        <div
          href='#'
          className='md:hidden flex justify-end items-center cursor-pointer pt-[47.5px] transform translate-x-0 transition-transform duration-300 ease-in-out group-hover:translate-x-2 '
        >
