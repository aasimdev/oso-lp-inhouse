  ...
  useEffect(() => {
    (async () => {
      if (checkoutSessionId) {
        ...
        console.log("res-----", sessionData.data);
          ...
          {previousPageUrl === "/search" ? (
            <>
              ...
              <p className="text-gray-800 text-2xl font-light">
                ...
                <br />
                In the mean-time, we invite you to test the iOS app and provide
                feedback to influence OSO&apos;s future.
              </p>
              <div className="mt-8 md:mt-16 flex flex-col-reverse md:flex-row gap-2 md:gap-6">
                ...
                <Link
                  href="https://l.oso.ai/OSOIOSBeta"
                  target="_blank"
