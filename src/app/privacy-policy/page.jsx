    ...
    <div>
      ...
      <p>
        ...
        <ul>
          ...
          <li>
            Protecting of business interests, processing of claims and
            complaints.
          </li>
        </ul>
      ...
      <h2>2. Purposes of Processing in Detail</h2>
      ...
      <h3>2.2 Maintaining Customer Relationships and Subscriptions</h3>
      <p>
      ...
      <h3>2.3 Providing the Service to Customers</h3>
      <p>
      ...
      <h3>2.4 Distribution of user developed plug-ins</h3>
      <p>
      ...
      <h3>2.5 Advertising and personalization</h3>
