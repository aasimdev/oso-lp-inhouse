  ...
  const accordionData = [
    {
      ...
      answer:
        "<p class='text-2xl leading-9 font-light text-gray-900'>OSO offers a more advanced and user-friendly suite of AI tools and services than any competitor and is constantly evolving, putting the needs of its users first.</p>",
    },
    {
      id: 2,
      question: "What is the difference between OSO Search and Chat?",
      answer:
        "<p class='text-2xl leading-9 font-light text-gray-900'>AI Chatbots are limited in the real-time information they can gather due to how they are created and trained." +
        "<br /><br />" +
    ...
    },
    {
      ...
      answer:
        "<p class='text-2xl leading-9 font-light text-gray-900'>OSO currently has a huge demand from people across the world, and we are letting in users from the waitlist as quickly as possible. Once you gain access, you can use OSO from Web, Android, and iOS.</p>",
    },
  ];
